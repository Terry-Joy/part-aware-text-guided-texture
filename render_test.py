...
if __name__ == "__main__":
    ...
    # ours exp
    # obj_dir = "/root/autodl-tmp/part-aware-text-guided-texture/inpaint_data/editing/vase_2/after_component5_inpaint/results/editing_use" 
    # out_dir = "/root/autodl-tmp/part-aware-text-guided-texture/inpaint_data/editing/vase_2/after_component5_inpaint/results/editing_use/endered_views"
    obj_dir = "/root/autodl-tmp/part-aware-text-guided-texture/inpaint_data/editing/vase_2/after_component5_inpaint/results/after_inpainting" 
    out_dir = "/root/autodl-tmp/part-aware-text-guided-texture/inpaint_data/editing/vase_2/after_component5_inpaint/results/after_inpainting"
    # obj_dir = "/home/zhangtianle/text-to-texture/SyncMVD/inpaint_test_data/duibibuquan/ours" 
    # out_dir = "/home/zhangtianle/text-to-texture/SyncMVD/inpaint_test_data/duibibuquan/ours/endered_views"
    ...
    views, paths = pipeline.render_and_save(out_dir, prefix="2fd7954d31dc47d7a48f9e0cb8faeeba", concat_mode="both")
