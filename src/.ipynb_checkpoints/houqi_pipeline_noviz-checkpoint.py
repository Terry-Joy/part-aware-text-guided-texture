...
def apply_global_style_injection_with_viz(latents, part_mask, output_dir="viz_results", eps=1e-6):
    """
...
class StableSyncMVDPipeline(StableDiffusionControlNetPipeline):
    ...
    def __call__(
        ...
        if adain_first:
            ...
            # latents = apply_global_style_injection_with_viz(latents, self.global_mask_96, self.viz_dir)
        self.uvp.to("cpu")
