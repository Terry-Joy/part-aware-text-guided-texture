...
class StableSyncMVDPipeline(StableDiffusionControlNetPipeline):
    ...
    def __call__(
        ...
        self.initialize_pipeline(
                ...
                ref_views=[],
                latent_size=height//8, # 96 latent_size * 8 = 
        ...
        conditioning_images, masks, _ = get_conditioning_images(self.uvp, height, cond_type=cond_type, img_path=img_path)
        ...
        # origin_mask = np.concatenate([img for img in origin_mask], axis=1)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if t > (1-multiview_diffusion_end)*num_timesteps:
                    ...
                    pred_original_sample = step_results["pred_original_sample"] # Z_{0|t}
