...
elif opt.cond_type == "segment":
	controlnet = ControlNetModel.from_pretrained("/mnt/lab/data/zhangtianle/train_controlnet/PartObjaverse-Tiny_mesh_checkpoint/20250627_175533/checkpoint-17000/controlnet", variant="fp16", torch_dtype=torch.float16)
